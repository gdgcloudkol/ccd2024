...
import { ATTENDEES_DJANGO_URL, EVENT_ATTENDEE_INFORM_ALL_URL, EVENT_ATTENDEE_INFORM_URL_SUFFIX } from '@/lib/constants/be';
...
export async function POST(req: NextRequest) {
    ...
    const response = await bkFetch(`${EVENT_ATTENDEE_INFORM_ALL_URL}`, {
        method: "POST",
        cache: 'no-store',
