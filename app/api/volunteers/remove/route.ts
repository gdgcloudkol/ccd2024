...
import { EVENTS_DJANGO_URL, EVENT_VOLUNTEER_REMOVE_URL_SUFFIX } from '@/lib/constants/be';
...
export async function POST(req: NextRequest) {
    ...
    const response = await bkFetch(EVENTS_DJANGO_URL + eventId + EVENT_VOLUNTEER_REMOVE_URL_SUFFIX, {
        method: "POST",
        cache: 'no-store',
