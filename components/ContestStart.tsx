...
const ContestStart = ({contestId, contestUri}: {
	contestId: number,
	contestUri: string
}) => {
		...
		if (!contestId) {
			...
			if (!response.ok) {
				...
				toast({
					...
					description: "Contest has been started, redirecting you to the contest portal.",
				});
	...
	return (
		<Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
			...
			<DialogContent>
				...
				<p>
					{" "}
					Are you sure you want to start the contest? You can attempt this contest for{" "}
					<strong> 1 attempt</strong>.
				</p>
				<p>
					Note:{" "}
					<strong>
						You have 2 hours to make your submission. Submissions after that will fail.
					</strong>
				</p>
				<DialogFooter>
					<Button
